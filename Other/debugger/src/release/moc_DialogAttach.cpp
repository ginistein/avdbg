...
#include "../os/win32/DialogAttach.h"
...
static const char qt_meta_stringdata_DialogAttach[] = {
    "DialogAttach\0\0text\0on_filter_textChanged(QString)\0"
    "checked\0on_filter_uid_clicked(bool)\0"
};
...
void DialogAttach::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_filter_textChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->on_filter_uid_clicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
