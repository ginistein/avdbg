...
**
** Created: Sat Sep 15 17:41:39 2012
...
static const char qt_meta_stringdata_SessionManager[] = {
    "SessionManager\0Evan Teran\0author\0"
...
const QMetaObjectExtraData SessionManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SessionManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SessionManager,
      qt_meta_data_SessionManager, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SessionManager::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SessionManager))
        return static_cast<void*>(const_cast< SessionManager*>(this));
    if (!strcmp(_clname, "DebuggerPluginInterface"))
        return static_cast< DebuggerPluginInterface*>(const_cast< SessionManager*>(this));
    if (!strcmp(_clname, "SessionFileInterface"))
        return static_cast< SessionFileInterface*>(const_cast< SessionManager*>(this));
