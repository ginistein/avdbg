...
BOOL Class_st::IfThisName(PSTR name)
{
...
Class_st* CClassManage::LoopUp_class_by_name(PSTR name)
{
	POSITION pos = this->m_classlist->GetHeadPosition();
	while (pos)
	{
...
CFuncType* Class_st::LookUp_SubFunc(PSTR name)
{
...
PSTR	Class_st::getclassitemname(DWORD off)
{
...
VarTypeID CClassManage::if_StrucName( PSTR &pstr )
{
	POSITION pos = this->m_classlist->GetHeadPosition();
	while (pos)
	{
